...
//	private final HttpContext httpContext;
	...
	public AsyncHttpClient(SchemeRegistry schemeRegistry) {
		...
		ConnManagerParams.setMaxTotalConnections(httpParams, maxConnections*2);
		...
		ClientConnectionManager cnnMng = null;
		...
		httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
			...
			public void process(HttpRequest request, HttpContext context) {
				...
				HttpUriRequest ori = (HttpUriRequest) wrapper.getOriginal();
				String url = ori.getURI().toString();
				Log.d("AsyncHttpClient", wrapper.getMethod() + ":" + url);
...
//					Log.d("AsyncHttpClient", response.getStatusLine().toString() + " --- " + response.getHeaders("Location")[0].getValue());
//				} else {
//					Log.d("AsyncHttpClient", response.getStatusLine().toString());
//				}
...
//		return Executors.newFixedThreadPool(10);
	...
	public void setTimeout(int timeout) {
		...
		HttpConnectionParams.setConnectionTimeout(httpParams, 7*1000);
	}
	...
	public RequestHandle head(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
		return sendRequest(httpClient, createHttpContext(), new HttpHead(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context);
	}
	...
	public RequestHandle head(Context context, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
		...
		return sendRequest(httpClient, createHttpContext(), request, null, responseHandler, context);
	}
	...
	public RequestHandle get(Context context, String url, RequestParams params, ResponseHandlerInterface responseHandler) {
		return sendRequest(httpClient, createHttpContext(), new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context);
	}
	...
	public RequestHandle post(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
		return sendRequest(httpClient, createHttpContext(), addEntityToRequestBase(new HttpPost(URI.create(url).normalize()), entity), contentType, responseHandler, context);
	}
	...
	public RequestHandle post(Context context, String url, Header[] headers, RequestParams params, String contentType, ResponseHandlerInterface responseHandler) {
		...
		if (headers != null)
			request.setHeaders(headers);
		return sendRequest(httpClient, createHttpContext(), request, contentType, responseHandler, context);
	}
	 ...
	 * @return RequestHandle of future request process
	 */
	public RequestHandle put(String url, String contentType, RequestParams params, ResponseHandlerInterface responseHandler) {
	 ...
	 * @return RequestHandle of future request process
	 */
	public RequestHandle put(Context context, String url, String contentType, RequestParams params, ResponseHandlerInterface responseHandler) {
		return put(context, url, paramsToPutEntity(params, responseHandler), contentType, responseHandler);
	}
	...
	public RequestHandle put(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
		return sendRequest(httpClient, createHttpContext(), addEntityToRequestBase(new HttpPut(URI.create(url).normalize()), entity), contentType, responseHandler, context);
	}
	...
	public RequestHandle delete(Context context, String url, ResponseHandlerInterface responseHandler) {
		...
		return sendRequest(httpClient, createHttpContext(), delete, null, responseHandler, context);
	}
	...
	public RequestHandle delete(Context context, String url, Header[] headers, RequestParams params, ResponseHandlerInterface responseHandler) {
		...
		return sendRequest(httpClient, createHttpContext(), httpDelete, null, responseHandler, context);
	}
	...
	protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
		...
		Log.d("Http client pool:", threadPool.toString());
	 ...
	 *            progress
	 */
	private HttpEntity paramsToPutEntity(RequestParams params, ResponseHandlerInterface responseHandler) {
			...
			if (params != null) {
				...
				if(!params.urlParams.isEmpty()){
					for(String key : params.urlParams.keySet()){
						obj.put(key, params.urlParams.get(key));
					}
					entity = new StringEntity(obj.toString(), "UTF-8");
				}else if(!params.fileParams.isEmpty()){
					SimpleMultipartEntity tempEntity = new SimpleMultipartEntity(responseHandler);
					for (ConcurrentHashMap.Entry<String, RequestParams.FileWrapper> entry : params.fileParams.entrySet()) {
						RequestParams.FileWrapper fileWrapper = entry.getValue();
						tempEntity.addPart(entry.getKey(), fileWrapper.file, fileWrapper.contentType);
					}
					return tempEntity;
				}else if(!params.urlParamsWithObjects.isEmpty()){
					JsonStreamerEntity tempEntity = new JsonStreamerEntity(responseHandler,false);
					for (ConcurrentHashMap.Entry<String, Object> entry : params.urlParamsWithObjects.entrySet()) {
						tempEntity.addPart(entry.getKey(), entry.getValue());
					}
					return tempEntity;
				}
