...
public class RequestParams {
     ...
     */
    public void put(String key, InputStream stream,String formKey) {
        put(key, stream, null,formKey);
    }
     ...
     */
    public void put(String key, InputStream stream, String name,String formKey) {
     ...
     * @param contentType the content type of the file, eg. application/json
     */
    public void put(String key, InputStream stream, String name,String formKey,String contentType) {
        put(key, stream, name, contentType, autoCloseInputStreams,formKey);
    }
     ...
     */
    public void put(String key, InputStream stream, String name, String contentType, boolean autoClose,String formKey) {
        if (key != null && stream != null) {
            streamParams.put(key, StreamWrapper.newInstance(stream, name, contentType, autoClose,formKey));
        }
    }
    ...
    private HttpEntity createMultipartEntity(ResponseHandlerInterface progressHandler) throws IOException {
        ...
        for (ConcurrentHashMap.Entry<String, StreamWrapper> entry : streamParams.entrySet()) {
            StreamWrapper stream = entry.getValue();
            if (stream.inputStream != null) {
                entity.addPart(stream.formKey, stream.name, stream.inputStream,
                        stream.contentType);
            }
        }
    ...
    public static class StreamWrapper {
        ...
        public StreamWrapper(InputStream inputStream, String name, String contentType, boolean autoClose,String formKey) {
        ...
        static StreamWrapper newInstance(InputStream inputStream, String name, String contentType, boolean autoClose,String formKey) {
